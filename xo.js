...
Object.defineProperty(xover.site, 'sections', {
    get() {
        let sections = new Proxy([...top.window.document.querySelectorAll(`[xo-stylesheet],[xo-store]`)], {
            get: function (self, key) {
                if (key in self) {
                    return self[key]
                } else {
...
xover.dom.createDialog = function (message) {
    ...
    if (message.documentElement instanceof HTMLHtmlElement) {
        ...
        iframe.onload = function () {
            iframe.style.height = (iframe.contentDocument.firstElementChild.scrollHeight + 100) + 'px';
